...
namespace RiskWinsRiskLosse
{
    class Program
    {
        static void Main()
        {
            ...
            int forbidenCombinationCount = int.Parse(Console.ReadLine());
            for (int i = 0; i < forbidenCombinationCount; i++)
            {
            ...
            //int count = 0;                                    //Greedy Solution -  84/100 - BGCoder
