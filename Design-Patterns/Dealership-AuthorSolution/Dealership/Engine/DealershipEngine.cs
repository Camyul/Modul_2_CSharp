...
namespace Dealership.Engine
{
    public sealed class DealershipEngine : IEngine
    {
        ...
        public DealershipEngine(ICommandHandlerProcessor commandHandler)
        {
        ...
        public void Start()
        {
            ...
            //var commandResult = this.commandHandler.Handle(command);
        ...
        private string ProcessSingleCommand(ICommand command)
        {
            ...
            //if (command.Name != "RegisterUser" && command.Name != "Login" && this.loggedUser == null)
            //{
